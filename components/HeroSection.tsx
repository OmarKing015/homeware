...
export function HeroSection() {
  return (
    ...
    >
      ...
      {/* <Image src={slim || "/placeholder.svg"} alt="image" fill /> */}
      <div className="absolute inset-0" style={{ backgroundColor: "rgba(58, 58, 58, 0.5)" }}></div>
      ...
      <div className="relative z-10 text-center p-4">
        ...
        <Button asChild size="lg" className="animate-pulse mt-6 text-black" variant="outline">
